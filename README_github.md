...
### For HR Managers 💼
HR folks need to manage people and process payrolls efficiently:
...
### 4. Real-Time Search
You can search for employees or payrolls by name or department without refreshing the page. I implemented this with vanilla JavaScript to keep things lightweight.
...
**2. Salary calculations:** Deciding whether to store the net salary or calculate it on-the-fly. I went with calculation using `@property` to avoid data inconsistencies.
...
Built this as a collaborative project with my teammate. We divided work by technical layers:
